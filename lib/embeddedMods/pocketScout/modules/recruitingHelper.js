...
async function synchronizeCommittedPlayerDestination({
   ...
   * PocketScout dynamic committed players table index v32
   *
   * Player[] remains runtime table ID 6123, but its table index can move
   * between dynasty layouts. Resolve the current index from the runtime
   * map/session instead of assuming table index 2000.
   */
  if (!tableIdMap.has(6123)) {
